...
if __name__ == "__main__":
    ...
    # surface = surface.scale([1.15, 1.15, 1.15])
    ...
    # # optimized resitances: [633400.1950934477, 690287.6356237876, 549691.977360423, 263587.08897456503, 736462.619039773]
