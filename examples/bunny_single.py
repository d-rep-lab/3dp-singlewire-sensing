...
if __name__ == "__main__":
    ...
    (
        ...
        resistor_trace_fill_kwargs={
            **default_args(generate_all_geometries)["resistor_trace_fill_kwargs"],
            "aiming_resistance": 400e3,  # 150% double: 850e3, single 750e3; 115% double: 650e3, single: 450e3
            "learning_rate": 0.1,
            "max_iterations": 300,
    ...
    wire_r, trace_r, score = optimize_resistances(
        ...
        # trace_resistance_candidates=[90e3],
    )
    ...
    #     connection_end_node=connection_end_node,
    #     set_of_link_path_positions=set_of_link_path_positions,
    #     save_file_basename=f"../models/results/{mesh_file_name}",
    ...
    #     resistor_trace_fill_kwargs={
    #         **default_args(generate_all_geometries)["resistor_trace_fill_kwargs"],
    #         "aiming_resistance": 2000e3,  # 150% double: 850e3, single 750e3; 115% double: 650e3, single: 450e3
    #         "learning_rate": 0.1,
    #         "max_iterations": 300,
    #         "no_overlap_margin": 2.0,
    #         "max_fill_area_radius": [1.0]
    ...
    # # p.add_mesh(combined_node_object, color="#222222")
    # # p.add_mesh(combined_resistor_object, color="#222222")
    ...
    # # np.array(
    # #     [472394.2646519923, 471957.9498449258, 468364.36563220597, 451219.5650847394]
    # # ) * 0.3
    ...
    # p.save_graphic("fabrication.pdf")
    p.show(window_size=window_size)
